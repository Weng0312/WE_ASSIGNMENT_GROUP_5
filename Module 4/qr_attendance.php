...
/*
    Use 2000m because iPhone GPS can be less accurate.
*/
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$serverLocationBlocked && $event) {
    ...
    /*
        Important:
        If location already verified in this browser session,
        do not check location again after submit.
    */
...
<<<<<<< Updated upstream:Module 4/qr_attendance.php
...
>>>>>>> Stashed changes:Module_4/qr_attendance.php
</head>
